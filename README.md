...
# Audience
The purpose of this website is to help people who are looking at getting back into football. The aim of the website was to showcase what the team is like after games and to give them a quick view of how the team has been performing. I provide information about the club and if the user is still interested in joining give them information about how the user can contact us or how we can contact the user.
# Design
...
[Responsinator](http://www.responsinator.com/?url=https%3A%2F%2Fjoshrudge22.github.io%2FKingshead-Fc%2F)

[Am I Responsive](https://ui.dev/amiresponsive?url=https://joshrudge22.github.io/Kingshead-Fc/)
...
# unresolved issues
I had a tough time in getting a higher performance score in when I ran the pages by lighthouse. This was due to the images that I was using, the images were the reason for a low score and after the advice my mentor gave me to use the website tinypng this did increase the score a little bit. After reviewing the score lighthouse did advise to turn the images from a png to a webp which I did, once I changed the photos from png to webp and but the webp images on the tinypng did score did increase.
